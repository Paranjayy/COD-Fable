...
export const WEAPON_DEFS = {
  ...
  shotgun: {
    ...
    recoil: {
      ...
      damping: 0.35,
      patternLength: 8,
      patternSeed: 0x870870,
      climbShape: [1.5, 1.2, 1.0],
      drift: 1.0,
    },
    adsTime: 0.28,
    adsFov: 0.82,
    ...
    drawTime: 0.7,
    holsterTime: 0.45,
    hipPos: [0.12, -0.19, -0.32],
    hipRot: [-0.05, 0.08, -0.14],
    adsCant: [0, 0, 0.004],
    eyeRelief: 0.12,
    sprintPos: [0.09, -0.27, -0.28],
    sprintRot: [-0.4, 0.6, 0.2],
    lowReadyPos: [0.11, -0.29, -0.30],
    lowReadyRot: [-0.45, 0.12, -0.09],
    swayScale: 1.2,
    bobScale: 1.1,
    magLen: 0.22,
  },
  ...
  sniper: {
    ...
    recoil: {
      ...
      damping: 0.3,
      patternLength: 5,
      patternSeed: 0x200200,
      climbShape: [1.8, 1.3, 1.0],
      drift: 1.2,
    },
    adsTime: 0.42,
    adsFov: 0.25,
    ...
    drawTime: 0.85,
    holsterTime: 0.55,
    hipPos: [0.13, -0.21, -0.35],
    hipRot: [-0.06, 0.09, -0.15],
    adsCant: [0, 0, 0.002],
    eyeRelief: 0.14,
    sprintPos: [0.1, -0.28, -0.3],
    sprintRot: [-0.42, 0.62, 0.22],
    lowReadyPos: [0.12, -0.3, -0.32],
    lowReadyRot: [-0.48, 0.13, -0.1],
    swayScale: 1.4,
    bobScale: 1.2,
    magLen: 0.25,
  },
